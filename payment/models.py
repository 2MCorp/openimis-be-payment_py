...
class Payment(core_models.VersionedModel):
    ...
    uuid = models.CharField(
        db_column="PaymentUUID", max_length=36, default=uuid.uuid4, unique=True
    )

    expected_amount = models.DecimalField(
        db_column="ExpectedAmount",
        max_digits=18,
        decimal_places=2,
        blank=True,
        null=True,
    ...
    def __str__(self):
        return (
            f"id:{self.id}, expected_amount: {self.expected_amount}, status:{self.status}, "
...
class PaymentDetail(core_models.VersionedModel):
    ...
    insurance_number = models.CharField(
        db_column="InsuranceNumber", max_length=12, blank=True, null=True
    )  # CHF_ID
    ...
    def __str__(self):
        return (
            f"id:{self.id}, payment:{self.payment_id}, ins_nb:{self.insurance_number}, amount:{self.amount}, "
